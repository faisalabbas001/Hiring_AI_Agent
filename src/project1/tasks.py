...
- Begin with the end goal in mind. Identify the specific outcome your tasks are aiming to achieve.
...
class TravelTasks:
    ...
    def plan_trip(self, agent, city , travel_dates , interests):
        return Task(
            description=dedent(
                f"""
            **Task**: Develop a 7-day Travel trip
      ...
      **Note**: {self.__tip_section()}
        ...
        """
            ...
            agent=agent,
            expected_output="A full 7-day itinerary including activities, food, stay, and travel logistics."
    ...
    def identify_city(self, agent, origin, cities, interests, travel_dates):
        ...
        """
            ...
            agent=agent,  
            expected_output="A detailed report on the best city, including flights, weather, events, and costs."
    ...
    def gather_city_info(self, agent, city, travel_dates, interests):
        ...
        """
            ...
            agent=agent,
            expected_output="A comprehensive city guide covering attractions, culture, and cost estimates."
